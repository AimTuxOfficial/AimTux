...
OBJECTS:= ./src/UI/component.o ./src/AimTux.o ./src/draw.o ./src/netvarmanager.o ./src/offsets.o ./src/hooker.o ./src/aimbot.o ./src/esp.o ./src/bhop.o ./src/spammer.o ./src/autostrafe.o ./src/entity.o ./src/antiaim.o ./src/triggerbot.o ./src/skinchanger.o ./src/math.o ./src/UI/window.o ./src/UI/panel.o
OUT := aimtux-csgo.so
