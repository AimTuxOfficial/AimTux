...
const std::map<int, PaintNames_t> itemSkins = {
		...
		{ 432, { "#PaintKit_am_awp_glory_Tag", "awp_glory" } },
		...
		{ 475, { "#PaintKit_cu_m4a1_hyper_beast_Tag", "m4a1_hyper_beast" } },
		...
		{ 487, { "#PaintKit_cu_cyrex_tag", "cyrex" } },
		...
		{ 537, { "#PaintKit_cu_m4a1_hyper_beast_Tag", "nova_hyperbeast" } },
