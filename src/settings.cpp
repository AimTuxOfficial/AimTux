...
void Settings::LoadDefaultsOrSave(std::string path)
{
	...
	settings["Aimbot"]["system_sens"] = Settings::Aimbot::system_sens;
...
void Settings::LoadConfig(std::string path)
{
	...
	GetFloat(settings["Aimbot"]["system_sens"], &Settings::Aimbot::system_sens);
	...
	GetFloat(settings["Radar"]["icons_scale"], &Settings::Radar::icons_scale);
