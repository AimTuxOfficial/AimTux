...
void MiscTab()
{
        ...
        ImGui::NextColumn();
        {
                ImGui::BeginChild("Child2", ImVec2(0, 0), true);
                {
                        ...
                        ImGui::InputText("##NICKNAMETEXT", Settings::ClanTagChanger::nickname, 127);

                        ImGui::SameLine();
                        if (ImGui::Button("Set Nickname", ImVec2(-1, 0)))
                                NameChanger::SetName(Settings::ClanTagChanger::nickname);

                        ImGui::Separator();
                        ImGui::PushItemWidth(-1);
                        ImGui::Combo("##NAMECOLORTYPE", &Settings::ClanTagChanger::color, colorTypes, IM_ARRAYSIZE(colorTypes));
                        ImGui::PopItemWidth();
                ...
                if (currentPlayer != -1)
                {
                        ...
                        ImGui::NextColumn();
                        {
                                if (ImGui::Button("Steal name"))
                                {
                                        ...
                                        Settings::ClanTagChanger::nickname = strdup(name.c_str());
                                        ClanTagChanger::SetName(Util::PadStringRight(name, name.length() + 1));
                                }
