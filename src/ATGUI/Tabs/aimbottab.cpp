...
void UI::UpdateWeaponSettings()
{
	...
	AimbotWeapon_t settings = {
			...
			noShootEnabled, ignoreJumpEnabled, smokeCheck, flashCheck, autoWallEnabled, autoWallValue, autoAimRealDistance, autoSlow, autoSlowMinDamage, spreadLimitEnabled, spreadLimitValue, predEnabled
	};
