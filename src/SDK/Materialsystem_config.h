...
*/
    unsigned int m_WindowedSizeLimitWidth;
    unsigned int m_WindowedSizeLimitHeight;
    int m_nAAQuality;
    ...
    bool cheatConfigInitialized; // set by us cheaters when the config has been copied over.
    ...
    MaterialSystem_Config_t()
    {
        ...
        m_bGammaTVEnabled = false; //IsX360(); If we make xbox port, change this
